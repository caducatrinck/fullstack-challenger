import type { IApiPaginationReturn, IGetListaProdutos, IGetProduct } from '@/types/produtos';
...
export default {
  ...
  get: async (page = 0, categories?: number): Promise<IApiPaginationReturn<IGetListaProdutos>> => {
    const params = {
      page,
      per_page: 10,
